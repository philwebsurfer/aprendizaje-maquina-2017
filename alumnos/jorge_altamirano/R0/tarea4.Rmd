...
```{r roc model1 train cf}
spam_entrena$probs_test1 <- predict(mod1, newdata = spam_entrena,
  spam = "response")
tableplot(spam_entrena, sortCol = probs_test1)
```
...
spam_prueba$probs_test3 <- predict(mod3, newdata = spam_prueba, spam = "response")
...
* Se generan muchos tickets y molestia por la falta de _accuracy_ pues requieren que se liberen correos en la lista de SPAM por falsos pisitovs 
